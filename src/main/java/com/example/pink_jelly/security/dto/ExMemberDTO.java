package com.example.pink_jelly.security.dto;
...
@Setter
@ToString
public class ExMemberDTO extends User {
    ...
    public ExMemberDTO(Long mno, String username, String password, String email, String memberName,
